...
public class PauseEarth extends Activity{
	...
	Intent i;
	 ...
	 int Time=0;
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			preff = getSharedPreferences("Earth_Data", Context.MODE_PRIVATE);
			...
			if(Time >= 60 ||  paused == false){
				...
				e.commit();
				//Intent i = new Intent(PauseEarth.this , EndSpace.class);
				//startActivity(i);
			...
			Rb.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					i = new Intent(PauseEarth.this , MainSpace.class);
					//space.paused = true;
					//space.PauseEarth(true);
					//i.putExtra("pp", true);
					startActivity(i);
			...
			Again.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent iAgain = new Intent(PauseEarth.this , PlayPage.class);
			...
			Home.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent iHome = new Intent(PauseEarth.this , HomePage.class);
					startActivity(iHome);
				}
			});
		}
