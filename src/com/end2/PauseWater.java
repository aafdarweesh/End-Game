...
public class PauseWater extends Activity{
	...
	Intent i;
	 ...
	 int Time=0;
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			preff = getSharedPreferences("Water_Data", Context.MODE_PRIVATE);
			...
			if(Time >= 60 ||  paused == false){
				...
				e.commit();
				//Intent i = new Intent(PauseWater.this , EndSpace.class);
				//startActivity(i);
			...
			Rb.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					i = new Intent(PauseWater.this , MainSpace.class);
					//space.paused = true;
					//space.PauseWater(true);
					//i.putExtra("pp", true);
					startActivity(i);
			...
			Again.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent iAgain = new Intent(PauseWater.this , PlayPage.class);
			...
			Home.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					Intent iHome = new Intent(PauseWater.this , HomePage.class);
					startActivity(iHome);
				}
			});
		}
